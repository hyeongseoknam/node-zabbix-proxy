...
class ZabbixSender(protocol.Protocol):
    ...
    def proxy(self):
        ...
        point = TCP4ClientEndpoint(reactor, "localhost", 10052)
        d = point.connect(zabbix_protocol.ZabbixFactory(self))
        d.addErrback(self.__zabbixServerConnectionFail)

    def __zabbixServerConnectionFail(self,e):
        print 'def __zabbixServerConnectionFail(self,e):',e
